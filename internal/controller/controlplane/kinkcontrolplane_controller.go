...
// TODO
func (r *KinkControlPlaneReconciler) reconcile(ctx context.Context, kinkCP *controlplanev1alpha1.KinkControlPlane) error {
...
func (r *KinkControlPlaneReconciler) ensureResources(ctx context.Context, owner client.Object, objs ...client.Object) error {
...
func (r *KinkControlPlaneReconciler) cleanupResources(ctx context.Context, kinkCP *controlplanev1alpha1.KinkControlPlane) error {
