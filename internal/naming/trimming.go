...
// Truncate will shorten the length of the instance name so that it contains at most max chars when combined with the
// fixed part. If the fixed part is already bigger than the max, this function is noop.
